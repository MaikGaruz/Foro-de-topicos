...
import com.example.demo.infra.security.DatosJWToken;
...
public class AutenticationController {
    ...
    @PostMapping
    public ResponseEntity auntenticacionUsuario(@RequestBody @Valid DatosAutenticacionUsuario datosAutenticacionUsuario){
